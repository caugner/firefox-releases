...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $RCSfile: staticobj.c,v $ $Revision: 1.1.6.2 $ $Date: 2006/02/03 22:31:00 $""; @(#) $RCSfile: staticobj.c,v $ $Revision: 1.1.6.2 $ $Date: 2006/02/03 22:31:00 $";
#endif /* DEBUG */
